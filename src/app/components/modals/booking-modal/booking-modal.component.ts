...
export class BookingModalComponent implements OnInit, OnDestroy {
  ...
  constructor(public activeModal: NgbActiveModal, private bookingService: BookingService, private fb: FormBuilder) {}
    ...
    this.setBookedDatesSubscription = this.bookingService
      ...
      .subscribe((isBookingSuccessful: boolean) => {
        if (isBookingSuccessful) {
          this.alert.message = this.bookingService.getAlertBookingSuccessMessage(this.bookedDates);
