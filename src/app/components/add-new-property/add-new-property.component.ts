...
export class AddNewPropertyDetailsComponent implements OnInit {
  ...
  constructor(private storageService: DataStorageService, private router: Router, private fb: FormBuilder) {}
  ...
  ngOnInit() {
    this.addPropertyForm = this.fb.group({
      ...
      price: [this.propertyData.price, [Validators.required, Validators.pattern(priceRegEx)]]
    });
  }
